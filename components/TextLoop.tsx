...
const TextLoop = ({
  ...
  useEffect(() => {
    ...
    // NOTE: reduced-motion opt-out removed — the landing page intentionally
    // forces its motion even under prefers-reduced-motion (globals.css
    // "Force landing motion" block). Matches that design policy.
