      ...
      {tickets.length > 1 && (
        <div className="mt-4 flex items-center justify-center gap-4">
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-background text-white transition-colors hover:bg-muted disabled:opacity-30"
